...
def is_docker_running() -> bool:
    ...
    Prefers checking the socket file (fast, works inside DinD containers),
    falls back to `docker info` subprocess.
    """
    # Fast path: check if the Docker socket exists and is a socket
